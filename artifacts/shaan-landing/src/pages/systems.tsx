...
const aiSystems = [
  {
    ...
    description: "How to speak to AI so it engineers extraordinary results.",
    route: "/system/prompt-engineering",
  },
];
...
function SystemCard({
  ...
  system: { id: string; title: string; description: string; route: string };
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-10">
            <p
              ...
              data-testid="section-personal-brand"
            >
              Personal Brand + Content
            </p>
            <div className="flex flex-col gap-4">
              {personalBrandSystems.map((s) => (
                <SystemCard key={s.id} system={s} onView={setLocation} />
              ))}
            </div>
          </div>
